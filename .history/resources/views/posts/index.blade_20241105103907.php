                ...
                <div class="col-lg-6 mb-4">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('posts.create') }}" class="btn btn-primary">Create New Post</a>
                            <a href="{{ route('posts.index') }}" class="btn btn-outline-secondary">View All Posts</
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{}" class="btn btn-success">Send New Email</a>
                            {{-- <a href="{{ route('emails.create') }}" class="btn btn-success">Send New Email</a>
                            <a href="{{ route('emails.index') }}" class="btn btn-outline-secondary">View All Emails</a> --}}
                            <a href="" class="btn btn-outline-secondary">View All Emails</a>
                        </div>
                    </div>
                </div>
            </div>
