...
<div class="d-flex">
    ...
    <div class="container-fluid p-4">
        ...
        <div class="mb-5">
            <h2 class="mb-3"><i class="fas fa-envelope text-primary me-2"></i> Email Management</h2>
            <div class="row g-4">
        ...
        <div>
            <h2 class="mb-3"><i class="fas fa-file-alt text-dark me-2"></i> Post Management</h2>
            <div class="card border-0 shadow rounded-3">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
