...
<body>
    ...
    <div class="sidebar d-flex flex-column p-3">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a href="{{ url('/posts/create') }}" class="btn btn-primary mb-2"><i class="fas fa-plus me-2"></i>Create Post</a>           
            </li>
            <li class="nav-item">
                <a href="{{ url('/posts') }}" class="btn btn-secondary"><i class="fas fa-th-list me-2"></i>Go to Posts</a>
            </li>
            <li class="nav-item">
