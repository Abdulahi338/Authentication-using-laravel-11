...
<body>
    ...
    <div class="sidebar d-flex flex-column p-3">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a href="#" class="{ url('/emails/incoming') }}"><i class="fas fa-inbox me-2"></i> Incoming Emails</a>
            </li>
            <li class="nav-item">
                <a href="#" class="{{ url('/emails/outgoing') }}"><i class="fas fa-paper-plane me-2"></i> Outgoing Emails</a>
            </li>
            <li class="nav-item">
