...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'password' => 'required|string|min:3|confirmed', // Stronger password policy
        ]);
        ...
        // Generate verification token with an expiration time (optional feature)
        $token = Str::random(32);
        ...
        // Provide feedback to the user and redirect them to login
